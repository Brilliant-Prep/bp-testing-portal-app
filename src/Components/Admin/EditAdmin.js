      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-6 text-right">
            <Link to={`/admins`} class="btn btn-outline-primary"><i className="fa fa-arrow-left"></i> Back to Admins</Link>
          </div>
        </div><br/>
        <form class="form-sample" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div class="row" style={{ marginTop: "20px" }}>
              <div class="col-md-12" align="right">
                <Link to={`/admins`} class="btn btn-outline-danger">Cancel</Link>
                {" "}
